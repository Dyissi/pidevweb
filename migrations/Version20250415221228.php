 ...
 */
final class Version20250415221228 extends AbstractMigration
{
    ...
    // here utf8mb4_0900_ai_ci  instead of  `utf8mb4_unicode_ci`  , and i couldn't re run this migration ! 
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE training_session CHANGE session_notes session_notes VARCHAR(250) NOT NULL, CHANGE team_id team_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
