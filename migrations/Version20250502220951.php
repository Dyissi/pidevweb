 ...
 */
final class Version20250502220951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE training_session CHANGE session_id session_id INT AUTO_INCREMENT NOT NULL, CHANGE session_start_time session_start_time DATETIME NOT NULL, CHANGE session_notes session_notes VARCHAR(1250) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE training_session CHANGE session_id session_id INT NOT NULL, CHANGE session_start_time session_start_time TIME NOT NULL, CHANGE session_notes session_notes VARCHAR(250) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE training_session ADD CONSTRAINT FK_TRAINING_LOCATION FOREIGN KEY (session_location) REFERENCES location (id) ON DELETE CASCADE
        SQL);
